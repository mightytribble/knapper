            ...
            "requestBody": {
                ...
                "content": { "application/json": { "schema": {
                    ...
                    "properties": {
                        ...
                        "scope": { "type": "array", "items": { "type": "string" }, "description": "Tag terms; a trailing / matches the tag and its descendants. Alias of all" },
    ...
    serde_json::json!({
        "get": {
            ...
            "parameters": [
                ...
                { "name": "scope", "in": "query", "required": false, "description": "Comma-separated tag terms; a trailing / matches the tag and its descendants. Alias of all", "schema": { "type": "string" } },
