...
pub const PENDING_MCP: &[Pending] = &[
    ...
    Pending::NotYetRemoved("context"),
    Pending::NotYetRemoved("read_section"),
...
pub const PENDING_HTTP: &[Pending] = &[
    ...
    Pending::NotYetAdded("/api/read"),
    Pending::NotYetAdded("/api/who"),
    Pending::NotYetAdded("/api/project"),
    Pending::NotYetAdded("/api/init"),
    Pending::NotYetAdded("/api/migrate"),
    Pending::NotYetRemoved("/api/read/{*file}"),
    Pending::NotYetRemoved("/api/who/{name}"),
    Pending::NotYetRemoved("/api/project/{name}"),
    Pending::NotYetRemoved("/api/read-section"),
